...
import com.gjq.demo.AppApplication;
import com.gjq.demo.BuildConfig;
import com.gjq.demo.commom.bsdiff.BSPatch;
...
public class DeltaUpdatesUtils {
    ...
    public static void checkUpdate(Context context) {
        Single.create((SingleOnSubscribe<File>) e -> {
            ...
            ApplicationInfo applicationInfo = AppApplication.getGlobalContext().getApplicationInfo();
