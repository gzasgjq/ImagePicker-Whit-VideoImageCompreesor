package com.gjq.demo.videocompressorlib;
...
public class FFMpegUtils {
    ...
    public static boolean captureThumbnails(String videoPath, String outputPath, String ss, String logPath) {
...
//		FFmpegBridge.jxFFmpegCMDRun(cmd);
        return FFmpegBridge.jxFFmpegCMDRun(getCaptureThumbnailsCMD(videoPath, outputPath, ss), logPath) == 0;
    }
     ...
     * @return
     */
    public static boolean captureThumbnails(String videoPath, String outputPath, String wh, String ss, String logPath) {
        //ffmpeg -i /storage/emulated/0/DCIM/04.04.mp4 -s 84x84 -vframes 1 /storage/emulated/0/DCIM/Camera/miaopai/1388843007381.jpg
        //ffmpeg -i eis-sample.mpg -s 40x40 -r 1/5 -vframes 10 %d.jpg
        FileUtils.deleteFile(outputPath);
        if (ss == null)
        ...
        return FFmpegBridge.jxFFmpegCMDRun(cmd, logPath) == 0;
    }
